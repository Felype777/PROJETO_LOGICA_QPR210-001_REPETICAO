...
//SPLICE ADICIONA EM UMA POSIÇÃO E NESSE EXEMPLO EXCLUIR MAIS DOIS ELEMENTOS A PARIR DA POSIÇÃO(INDÍCE) INFORMADO
pessoas.splice(3,2,{nome: 'Extraterreste', idade: 250, renda: 0.50})

//SPLICE EXCLUIR UMA POSIÇÃO E NESSE EXEMPLO EXCLUIR APENAS O ELEMENTOS DA POSIÇÃO(INDÍCE) INFORMADO
pessoas.splice(1,0)

//SPLICE EXCLUIR DOIS ELEMENTOS A PARTIR DA POSIÇÃO(INDÍCE) INFORMADA
pessoas.splice(2,2)
